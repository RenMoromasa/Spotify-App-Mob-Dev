...
      // ADD THIS onPress PROP
      onPress={() => {
        // 1. Navigate to 'PlaylistsScreen'
        // 2. Pass the item's data (id and title) as navigation parameters
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View style={styles.header}>
          ...
          {/* RIGHT: Profile button (navigates to profile) */}

          {/* Added a spacer to push the profile icon to the far right */}
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('Profile')} // Changed to navigate

            style={styles.circleButton}

          >

            {/* Using the person-circle icon for the profile */}
        ...
        {/* --- NEW: Your Favorite Album (Conditional rendering) --- */}
        ...
        {FAVORITE_ALBUM_DATA.length > 0 && (
          ...
          <>
            ...
            <View style={{ paddingLeft: 16, marginBottom: 20 }}>
              ...
              {/* Rendering a single album item by manually calling renderAlbum */}
...
// --- STATIC STYLESHEET (No changes needed here) ---
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    // Ensure space-between is used to push the elements apart
  ...
  circleButton: {
    ...
    // Removed marginRight/marginLeft here to allow 'space-between' to manage spacing
  ...
  cylinderRow: {
    ...
    // Add margin to separate from the left menu icon
